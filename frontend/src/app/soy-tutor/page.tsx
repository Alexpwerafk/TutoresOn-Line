...
export default function SoyTutor() {
  return (
    <div className="min-h-screen p-8 bg-academic-platinum dark:bg-academic-oxford text-academic-oxford dark:text-white flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-3xl font-bold mb-4">Monetiza tus conocimientos</h2>
        <p className="text-gray-600 dark:text-gray-300 max-w-lg text-lg">
          Pronto podrás registrar tu perfil profesional, establecer tus tarifas por hora, y empezar a recibir solicitudes de estudiantes de todo el mundo.
        </p>
      </main>
    </div>
  );
